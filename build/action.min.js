(function(f){f.action=new function(){var a=this,e=Date.now(),d=0,b,c,g,k,f,h,m,r,l=[],n=24,p;this.__defineGetter__("pageLoadTime",function(){return d});this.createLog=function(a,e){a=a||300;e=e||!1;b=document.createElement("div");b.style.position="absolute";e?(b.style.bottom="0px",b.style.left="0px",b.style.width="100%",b.style.height=String(a)+"px"):(b.style.top="0px",b.style.right="0px",b.style.width=String(a)+"px",b.style.height="100%");b.style.backgroundColor="#CCCCCC";b.style.fontFamily="Consolas, monaco, monospace";
b.style.fontSize="14px";b.style.overflowX="auto";b.style.overflowY="scroll";b.innerHTML="Action.JS Output<br><br>";document.body.appendChild(b)};this.createStage=function(e,b,d,l,n,p){k=e||0;f=b||0;h=d||800;m=l||600;r=n||"#FFFFFF";c=document.createElement("canvas");c.width=h;c.height=m;c.style.position="absolute";c.style.top=String(f)+"px";c.style.left=String(k)+"px";c.style.border=p||"1px solid #000000";g=c.getContext("2d");a.clearStage();document.body.appendChild(c)};this.setLog=function(a){b=document.getElementById(a);
b.style.fontFamily="Consolas, monaco, monospace";b.style.fontSize="14px";b.innerHTML="Action.JS Output<br><br>"};this.setStage=function(e,b){c=document.getElementById(e);k=a.util.elementPosition(c).left;f=a.util.elementPosition(c).top;h=c.width;m=c.height;g=c.getContext("2d");r=b||"#FFFFFF";a.clearStage()};this.__defineGetter__("canvas",function(){return c});this.__defineGetter__("stage",function(){return g});this.__defineGetter__("stageX",function(){return k});this.__defineGetter__("stageY",function(){return f});
this.__defineGetter__("stageWidth",function(){return h});this.__defineGetter__("stageHeight",function(){return m});this.__defineGetter__("numDisplayed",function(){return l.length});this.__defineGetter__("fps",function(){return n});this.__defineSetter__("fps",function(a){clearInterval(p);n=a;s()});var t=setInterval(function(){"complete"===document.readyState&&(d=Date.now()-e,a.main?a.main():console.log("Action.JS Warning: no function action.main() found"),clearInterval(t))},10),s=function(){p=setInterval(function(){a.dispatchEvent(a.events.ENTER_FRAME);
a.clearStage();a.drawAll()},Math.ceil(1E3/n))};this.kill=function(){clearInterval(p)};this.log=function(a){b.innerHTML+=">"+String(a)+"<br>";b.scrollTop=b.scrollHeight};this.title=function(a){document.title=a};this.clearStage=function(){g.fillStyle=r;g.fillRect(0,0,h,m)};this.drawAll=function(){for(var a=0;a<l.length;a++)l[a].draw(g)};this.display=function(e){a.undisplay(e);l.push(e);e.displayed=!0};this.undisplay=function(a){for(var e=0;e<l.length;e++)if(l[e]===a){l.splice(e,1);a.displayed=!1;break}}}})(window);
(function(f,a){a.calc={};a.calc.DEG2RAD=Math.PI/180;a.calc.RAD2DEG=180/Math.PI;a.calc.inRange=function(a,d,b){return d<=a&&a<=b};a.calc.distance=function(a,d,b,c){a=b-a;d=c-d;return Math.sqrt(a*a+d*d)};a.calc.rotate=function(a,d,b,c,g){var k=Math.sin(g);g=Math.cos(g);a-=b;d-=c;return{x:a*g-d*k+b,y:a*k+d*g+c}};a.calc.boundingBox=function(e){if(0===e.rotation%360)return{x:e.x-e.center.x*e.scaleX,y:e.y-e.center.y*e.scaleY,width:e.width*e.scaleX,height:e.height*e.scaleY};for(var d=[{x:0,y:0},{x:e.width*
e.scaleX,y:0},{x:e.width*e.scaleX,y:e.height*e.scaleY},{x:0,y:e.height*e.scaleY}],b=[],c,g=0;4>g;g++)c=d[g],b.push(a.calc.rotate(c.x,c.y,e.center.x,e.center.y,e.rotation*a.calc.DEG2RAD));for(var d=b[0].x,k=b[0].y,f=b[2].x,h=b[2].y,g=0;4>g;g++)c=b[g],c.x<d&&(d=c.x),c.x>f&&(f=c.x),c.y<k&&(k=c.y),c.y>h&&(h=c.y);b=e.x-e.center.x*e.scaleX;e=e.y-e.center.y*e.scaleY;d+=b;k+=e;return{x:d,y:k,width:f+b-d,height:h+e-k}};a.calc.ptCollisionRect=function(e,d,b){return b.displayed?(b=a.calc.boundingBox(b),a.calc.inRange(e,
b.x,b.x+b.width)&&a.calc.inRange(d,b.y,b.y+b.height)):!1};a.calc.ptCollisionCirc=function(e,d,b){if(b.displayed){b=a.calc.boundingBox(b);var c=b.width>b.height?b.width:b.height;return a.calc.distance(e,d,b.x+b.width/2,b.y+b.height/2)<=c}return!1};a.calc.collisionRect=function(e,d){if(e.displayed&&d.displayed){var b=a.calc.boundingBox(e),c=a.calc.boundingBox(d);return(a.calc.inRange(b.x,c.x,c.x+c.width)||a.calc.inRange(c.x,b.x,b.x+b.width))&&(a.calc.inRange(b.y,c.y,c.y+c.height)||a.calc.inRange(c.y,
b.y,b.y+b.height))}return!1};a.calc.collisionCirc=function(e,d){if(e.displayed&&d.displayed){var b=a.calc.boundingBox(e),c=a.calc.boundingBox(d),g=b.width>b.height?b.width:b.height,f=c.width>c.height?c.width:c.height;return a.calc.distance(b.x+b.width/2,b.y+b.height/2,c.x+c.width/2,c.y+c.height/2)<=g+f}return!1}})(window,action);
(function(f,a){a.util={};a.util.addEventHandler=function(a,d,b){a.addEventListener?a.addEventListener(d,b):a.attachEvent&&a.attachEvent("on"+d,b)};a.util.removeEventHandler=function(a,d,b){a.removeEventListener?a.removeEventListener(d,b):a.detachEvent&&a.detachEvent("on"+d,b)};a.util.extend=function(a,d){function b(){a.apply(this);d.apply(this,arguments)}d=d||function(){};b.prototype=a.prototype;return b};a.util.arrayRemove=function(a,d){for(var b=0;b<a.length;b++)a[b]===d&&a.splice(b,1)};a.util.elementPosition=
function(a){var d=0,b=0;if(a.offsetParent){do d+=a.offsetLeft,b+=a.offsetTop;while(a=a.offsetParent)}return{left:d,top:b}};a.util.browser=function(){var a=navigator.appName,d=navigator.userAgent,b,c=d.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);c&&null!=(b=d.match(/version\/([\.\d]+)/i))&&(c[2]=b[1]);c=c?[c[1],c[2]]:[a,navigator.appVersion,"-?"];return{name:c[0].toLowerCase(),version:c[1]}}();a.util.browser.os=function(){var a=navigator.platform.toLowerCase();return-1!=a.indexOf("win")?
"windows":-1!=a.indexOf("mac")?"mac":-1!=a.indexOf("iphone")||-1!=a.indexOf("ipod")||-1!=a.indexOf("ipad")?"iOS":-1!=a.indexOf("linux")?"linux":"unknown"}();a.util.browser.hasJava=navigator.javaEnabled();a.util.browser.agent=navigator.userAgent})(window,action);
...
(function(f,a){a.Image=function(e){var d=this;this.displayed=!1;this.height=this.width=this.y=this.x=0;this.center={x:0,y:0};this.scaleY=this.scaleX=1;this.rotation=0;var b=e;this.__defineGetter__("src",function(){return b});this.__defineSetter__("src",function(a){b=a;c.src=b});var c=new Image;a.util.addEventHandler(c,"load",function(){d.width=c.width;d.height=c.height});c.src=b;this.load=function(b){a.util.addEventHandler(c,"load",b)};this.draw=function(b){b.save();b.translate(d.x,d.y);b.rotate(d.rotation*
a.calc.DEG2RAD);b.drawImage(c,-d.center.x*d.scaleX,-d.center.y*d.scaleY,d.width*d.scaleX,d.height*d.scaleY);b.restore()}}})(window,action);
(function(f,a){a.Animation=function(e,d,b){var c=this;this.displayed=!1;this.y=this.x=0;this.width=d;this.height=b;this.center={x:0,y:0};this.scaleY=this.scaleX=1;var g=this.rotation=0,f=0,q=e;this.__defineGetter__("src",function(){return q});this.__defineSetter__("src",function(a){q=a;h.src=q});var h=new Image;a.util.addEventHandler(h,"load",function(){g=Math.round(h.width/c.width)});h.src=q;a.addEventListener(a.events.ENTER_FRAME,function(){f++;f%=g});this.draw=function(b){b.save();b.translate(c.x,
