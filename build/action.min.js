(function(f){f.action=new function(){var a=this,d=Date.now(),e=0,b,c,g,h,q,k,f,m,l=[],n=24,p;this.__defineGetter__("pageLoadTime",function(){return e});this.createLog=function(a,c){a=a||300;c=c||!1;b=document.createElement("div");b.style.position="absolute";c?(b.style.bottom="0px",b.style.left="0px",b.style.width="100%",b.style.height=String(a)+"px"):(b.style.top="0px",b.style.right="0px",b.style.width=String(a)+"px",b.style.height="100%");b.style.backgroundColor="#CCCCCC";b.style.fontFamily="Consolas, monaco, monospace";
b.style.fontSize="14px";b.style.overflowX="auto";b.style.overflowY="scroll";b.innerHTML="Action.JS Output<br><br>";document.body.appendChild(b)};this.createStage=function(b,d,e,n,l,p){h=b||0;q=d||0;k=e||800;f=n||600;m=l||"#FFFFFF";c=document.createElement("canvas");c.width=k;c.height=f;c.style.position="absolute";c.style.top=String(q)+"px";c.style.left=String(h)+"px";c.style.border=p||"1px solid #000000";g=c.getContext("2d");a.clearStage();document.body.appendChild(c)};this.setLog=function(a){b=document.getElementById(a);
b.style.fontFamily="Consolas, monaco, monospace";b.style.fontSize="14px";b.innerHTML="Action.JS Output<br><br>"};this.setStage=function(b,d){c=document.getElementById(b);h=a.util.elementPosition(c).left;q=a.util.elementPosition(c).top;k=c.width;f=c.height;g=c.getContext("2d");m=d||"#FFFFFF";a.clearStage()};this.__defineGetter__("canvas",function(){return c});this.__defineGetter__("stage",function(){return g});this.__defineGetter__("stageX",function(){return h});this.__defineGetter__("stageY",function(){return q});
this.__defineGetter__("stageWidth",function(){return k});this.__defineGetter__("stageHeight",function(){return f});this.__defineGetter__("numDisplayed",function(){return l.length});this.__defineGetter__("fps",function(){return n});this.__defineSetter__("fps",function(a){clearInterval(p);n=a;s()});var t=setInterval(function(){"complete"===document.readyState&&(e=Date.now()-d,a.main?a.main():console.log("Action.JS Warning: no function action.main() found"),clearInterval(t))},10),s=function(){p=setInterval(function(){a.dispatchEvent(a.events.ENTER_FRAME);
a.clearStage();a.drawAll()},Math.ceil(1E3/n))};this.kill=function(){clearInterval(p)};this.log=function(a){b.innerHTML+=">"+String(a)+"<br>";b.scrollTop=b.scrollHeight};this.title=function(a){document.title=a};this.clearStage=function(){g.fillStyle=m;g.fillRect(0,0,k,f)};this.drawAll=function(){for(var a=0;a<l.length;a++)l[a].draw(g)};this.display=function(c){a.undisplay(c);l.push(c);c.displayed=!0};this.undisplay=function(a){for(var c=0;c<l.length;c++)if(l[c]===a){l.splice(c,1);a.displayed=!1;break}}}})(window);
(function(f,a){a.calc={};a.calc.DEG2RAD=Math.PI/180;a.calc.RAD2DEG=180/Math.PI;a.calc.inRange=function(a,e,b){return e<=a&&a<=b};a.calc.distance=function(a,e,b,c){a=b-a;e=c-e;return Math.sqrt(a*a+e*e)};a.calc.rotate=function(a,e,b,c,g){var h=Math.sin(g);g=Math.cos(g);a-=b;e-=c;return{x:a*g-e*h+b,y:a*h+e*g+c}};a.calc.boundingBox=function(d){if(0===d.rotation%360)return{x:d.x-d.center.x*d.scaleX,y:d.y-d.center.y*d.scaleY,width:d.width*d.scaleX,height:d.height*d.scaleY};for(var e=[{x:0,y:0},{x:d.width*
d.scaleX,y:0},{x:d.width*d.scaleX,y:d.height*d.scaleY},{x:0,y:d.height*d.scaleY}],b=[],c,g=0;4>g;g++)c=e[g],b.push(a.calc.rotate(c.x,c.y,d.center.x,d.center.y,d.rotation*a.calc.DEG2RAD));for(var e=b[0].x,h=b[0].y,f=b[2].x,k=b[2].y,g=0;4>g;g++)c=b[g],c.x<e&&(e=c.x),c.x>f&&(f=c.x),c.y<h&&(h=c.y),c.y>k&&(k=c.y);b=d.x-d.center.x*d.scaleX;d=d.y-d.center.y*d.scaleY;e+=b;h+=d;return{x:e,y:h,width:f+b-e,height:k+d-h}};a.calc.ptCollisionRect=function(d,e,b){return b.displayed?(b=a.calc.boundingBox(b),a.calc.inRange(d,
...
b.y,b.y+b.height))}return!1};a.calc.collisionCirc=function(d,e){if(d.displayed&&e.displayed){var b=a.calc.boundingBox(d),c=a.calc.boundingBox(e),g=b.width>b.height?b.width:b.height,h=c.width>c.height?c.width:c.height;return a.calc.distance(b.x+b.width/2,b.y+b.height/2,c.x+c.width/2,c.y+c.height/2)<=g+h}return!1}})(window,action);
(function(f,a,d){d.util={};d.util.addEventHandler=function(a,b,c){a.addEventListener?a.addEventListener(b,c):a.attachEvent&&a.attachEvent("on"+b,c)};d.util.removeEventHandler=function(a,b,c){a.removeEventListener?a.removeEventListener(b,c):a.detachEvent&&a.detachEvent("on"+b,c)};d.util.include=function(e,b,c){function g(){f||k.readyState&&"complete"!==k.readyState||(f=!0,b(),d.util.removeEventHandler(k,"load",g),d.util.removeEventHandler(k,"readystatechange",g))}c=c||!1;b=b||function(){};var h=a.getElementsByTagName("script"),
f,k=a.createElement("script");k.type="text/javascript";k.src=e+"?"+Date.now();d.util.addEventHandler(k,"load",g);d.util.addEventHandler(k,"readystatechange",g);c?h[h.length-1].parentNode.appendChild(k):h[0].parentNode.insertBefore(k,h[0])};d.util.extend=function(a,b){function c(){a.apply(this);b.apply(this,arguments)}b=b||function(){};c.prototype=a.prototype;return c};d.util.arrayRemove=function(a,b){for(var c=0;c<a.length;c++)a[c]===b&&a.splice(c,1)};d.util.elementPosition=function(a){var b=0,c=
...
(function(f,a){a.Animation=function(d,e,b){var c=this;this.displayed=!1;this.y=this.x=0;this.width=e;this.height=b;this.center={x:0,y:0};this.scaleY=this.scaleX=1;var g=this.rotation=0;this.__defineGetter__("numFrames",function(){return g});var h=0,f=d;this.__defineGetter__("src",function(){return f});this.__defineSetter__("src",function(a){f=a;k.src=f});var k=new Image;a.util.addEventHandler(k,"load",function(){g=Math.round(k.width/c.width);c.play(!0)});f&&(k.src=f);this.load=function(b){a.util.addEventHandler(k,
"load",b)};var r=!1;this.__defineGetter__("playing",function(){return r});var m,l=function(){h++;!m&&h>=g?c.stop():h%=g};this.play=function(b){m=b||!1;a.addEventListener(a.events.ENTER_FRAME,l);r=!0};this.stop=function(){a.removeEventListener(a.events.ENTER_FRAME,l);h=0;r=!1};this.draw=function(b){b.save();b.translate(c.x,c.y);b.rotate(c.rotation*a.calc.DEG2RAD);b.drawImage(k,h*c.width,0,c.width,c.height,-c.center.x*c.scaleX,-c.center.y*c.scaleY,c.width*c.scaleX,c.height*c.scaleY);b.restore()}}})(window,
action);(function(f,a){a.Sprite=function(){var a=this;this.displayed=!1;this.height=this.width=this.y=this.x=0;this.center={x:0,y:0};this.scaleY=this.scaleX=1;this.rotation=0;var e={},b;this.addState=function(a,b){e[a]=b};this.removeState=function(a){delete e[a]};this.showState=function(c){b=e[c];a.width=b.width;a.height=b.height};this.draw=function(c){b.x=a.x;b.y=a.y;b.center=a.center;b.scaleX=a.scaleX;b.scaleY=a.scaleY;b.rotation=a.rotation;b.draw(c)}}})(window,action);
