...
b.style.fontSize="14px";b.style.overflowX="auto";b.style.overflowY="scroll";b.innerHTML="Action.JS Output<br><br>";document.body.appendChild(b)};this.createStage=function(b,e,d,l,n,p){h=b||0;f=e||0;k=d||800;m=l||600;r=n||"#FFFFFF";c=document.createElement("canvas");c.width=k;c.height=m;c.style.position="absolute";c.style.top=String(f)+"px";c.style.left=String(h)+"px";c.style.border=p||"1px solid #000000";g=c.getContext("2d");a.clearStage();document.body.appendChild(c)};this.setLog=function(a){b=document.getElementById(a);
b.style.fontFamily="Consolas, monaco, monospace";b.style.fontSize="14px";b.innerHTML="Action.JS Output<br><br>"};this.setStage=function(b,e){c=document.getElementById(b);h=a.util.elementPosition(c).left;f=a.util.elementPosition(c).top;k=c.width;m=c.height;g=c.getContext("2d");r=e||"#FFFFFF";a.clearStage()};this.__defineGetter__("canvas",function(){return c});this.__defineGetter__("stage",function(){return g});this.__defineGetter__("stageX",function(){return h});this.__defineGetter__("stageY",function(){return f});
...
c&&null!=(b=d.match(/version\/([\.\d]+)/i))&&(c[2]=b[1]);c=c?[c[1],c[2]]:[a,navigator.appVersion,"-?"];return{name:c[0].toLowerCase(),version:c[1]}}();a.util.browser.hasJava=navigator.javaEnabled();a.util.browser.agent=navigator.userAgent})(window,action);
(function(f,a){a.events={};a.events.READY="ready";a.events.LOAD="load";a.events.ENTER_FRAME="enterframe";a.events.CLICK="click";a.events.MOUSE_MOVE="mousemove";a.events.MOUSE_DOWN="mousedown";a.events.MOUSE_UP="mouseup";a.events.MOUSE_WHEEL="mouse_wheel";a.events.KEY_DOWN="keydown";a.events.KEY_UP="keyup";a.events.click=function(e,d){a.addEventListener(a.events.CLICK,function(){a.calc.ptCollisionRect(a.mouse.x,a.mouse.y,e)&&d()})};a.addEventListener=function(e,d){a.util.addEventHandler(f,e,d)};a.removeEventListener=
function(e,d){a.util.removeEventHandler(f,e,d)};a.dispatchEvent=function(a,d){d=d||{};f.dispatchEvent(new CustomEvent(a,{detail:d}))};a.addEventListener("firefox"===a.util.browser.name?"DOMMouseScroll":"mousewheel",function(e){a.dispatchEvent(a.events.MOUSE_WHEEL,{delta:e.detail?-1*e.detail:e.wheelDelta/120})})})(window,action);
