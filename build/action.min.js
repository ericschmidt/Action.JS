(function(f){f.action=new function(){var a=this,e=Date.now(),d=0,b,c,g,k,f,h,m,r,l=[],n=24,p;this.__defineGetter__("pageLoadTime",function(){return d});this.createLog=function(a,c){a=a||300;c=c||!1;b=document.createElement("div");b.style.position="absolute";c?(b.style.bottom="0px",b.style.left="0px",b.style.width="100%",b.style.height=String(a)+"px"):(b.style.top="0px",b.style.right="0px",b.style.width=String(a)+"px",b.style.height="100%");b.style.backgroundColor="#CCCCCC";b.style.fontFamily="Consolas, monaco, monospace";
...
a.clearStage();a.drawAll()},Math.ceil(1E3/n))};this.kill=function(){clearInterval(p)};this.log=function(a){b.innerHTML+=">"+String(a)+"<br>";b.scrollTop=b.scrollHeight};this.title=function(a){document.title=a};this.clearStage=function(){g.fillStyle=r;g.fillRect(0,0,h,m)};this.drawAll=function(){for(var a=0;a<l.length;a++)l[a].draw(g)};this.display=function(c){a.undisplay(c);l.push(c);c.displayed=!0};this.undisplay=function(a){for(var c=0;c<l.length;c++)if(l[c]===a){l.splice(c,1);a.displayed=!1;break}}}})(window);
...
(function(f,a){a.util={};a.util.addEventHandler=function(a,d,b){a.addEventListener?a.addEventListener(d,b):a.attachEvent&&a.attachEvent("on"+d,b)};a.util.removeEventHandler=function(a,d,b){a.removeEventListener?a.removeEventListener(d,b):a.detachEvent&&a.detachEvent("on"+d,b)};a.util.extend=function(a,d){function b(){a.apply(this);d.apply(this,arguments)}d=d||function(){};b.prototype=a.prototype;return b};a.util.elementPosition=function(a){var d=0,b=0;if(a.offsetParent){do d+=a.offsetLeft,b+=a.offsetTop;
while(a=a.offsetParent)}return{left:d,top:b}};a.util.browser=function(){var a=navigator.appName,d=navigator.userAgent,b,c=d.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);c&&null!=(b=d.match(/version\/([\.\d]+)/i))&&(c[2]=b[1]);c=c?[c[1],c[2]]:[a,navigator.appVersion,"-?"];return{name:c[0].toLowerCase(),version:c[1]}}();a.util.browser.os=function(){var a=navigator.platform.toLowerCase();return-1!=a.indexOf("win")?"windows":-1!=a.indexOf("mac")?"mac":-1!=a.indexOf("iphone")||-1!=
a.indexOf("ipod")||-1!=a.indexOf("ipad")?"iOS":-1!=a.indexOf("linux")?"linux":"unknown"}();a.util.browser.hasJava=navigator.javaEnabled();a.util.browser.agent=navigator.userAgent})(window,action);
